...
namespace MVC_1.Migrations
{
    ...
    [Migration("20230414162723_Ver-15")]
    partial class Ver15
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVC_1.Models.Post", b =>
                {
            ...
            modelBuilder.Entity("MVC_1.Models.PostCategory", b =>
                {
                    b.Property<int>("CategoryID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Models.Product.ProductModel", b =>
                {
                    b.HasOne("MVC_1.Models.AppUser", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("MVC_1.Models.Category", b =>
                {
                    b.HasOne("MVC_1.Models.Category", "ParentCategory")
                        .WithMany("CategoryChildren")
            ...
            modelBuilder.Entity("MVC_1.Models.PostCategory", b =>
                {
                    ...
                    b.HasOne("MVC_1.Models.Post", "Post")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MVC_1.Models.AppUser", null)
                        .WithMany()
